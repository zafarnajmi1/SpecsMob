...
@section('content')
    <!-- Header -->
    <div class="relative w-full h-72 md:h-[314px] bg-cover bg-center mb-[10px]" style='background-image: url("{{ asset('user/images/account.jpg') }}");'>
        <!-- Top bar -->
        <div class="absolute top-0 left-0 border-b-1 border-gray-400 shadow flex justify-between items-center w-full px-4 py-3 md:px-6 z-10"></div>
    ...
    <div class="mt-3">
        <h3 class="border-l-[10px] border-l-[rgba(88,160,22,.5)] pt-[5px] pl-[20px] text-[21px] font-bold text-[#555]">In device specs</h3>
    ...
    <!-- Reviews Section -->
    <div class="mt-3">
        <h3 class="border-l-[10px] border-l-[#ed9d9d] pt-[5px] pl-[20px] text-[21px] font-bold text-[#555]">In reviews</h3>
    ...
    <!-- Articles Section -->
    <div class="mt-3">
        <h3 class="border-l-[10px] border-l-[#17819f] pt-[5px] pl-[20px] text-[21px] font-bold text-[#555]">In articles</h3>
