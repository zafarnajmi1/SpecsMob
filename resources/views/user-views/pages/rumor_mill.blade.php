...
@section('title', 'Rumor Mill - Rumored Devices')
...
<section class="lg:hidden">
    ...
    <div class="relative w-full h-[316px] bg-cover bg-center"
        style='background-image: url("{{ asset('rumored.jpg') }}");'>
        <div class="absolute inset-0 bg-black/30"></div>
        <div class="absolute bottom-0 left-0 w-full p-4">
            <h1 class="text-white text-2xl font-bold drop-shadow-lg">Rumor Mill</h1>
            <p class="text-white/90 text-sm mt-1">Upcoming & Rumored Devices</p>
        </div>
    </div>
    ...
    <div class="bg-white p-3">
                    ...
                    <div class="relative flex items-center bg-white border border-gray-200 rounded overflow-hidden hover:shadow-md transition">
                        ...
                        <a href="{{ route('device-detail', $device->slug) }}" class="flex flex-1 items-center device-link">
                            ...
                            <div class="flex-1 p-3">
                                ...
                                <p class="text-xs text-[#F9A13D] mt-1">Rumored</p>
                            </div>
                        </a>
                    </div>
                @endforeach
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-600">No rumored devices found</p>
            </div>
        @endif
    </div>
</section>
        ...
        <div class="container mx-auto">
            <form action="{{ url()->current() }}" method="GET" id="filter-form"
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    {{-- Reset Link --}}
                    @if(request()->anyFilled(['q', 'type', 'year']))
                ...
                <div
                    ...
                    SHOWING <span class="text-[#F9A13D]">{{ $devices->total() }}</span> RUMORED DEVICES
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="container mx-auto px-4">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-xl text-gray-600 mb-2">No rumored devices found</h3>
                    <p class="text-gray-500">Check back later for upcoming device rumors.</p>
                </div>
            @endif
        </div>
    </div>
