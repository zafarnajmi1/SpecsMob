...
@section('content')
                ...
                @foreach($relatedArticles as $related)
                    <div
                        ...
                        <a href="{{ route('article-detail', ['slug' => $related->slug, 'type' => $related->type]) }}">
                            ...
                            <div class="p-4">
                                <h4 class="font-bold text-gray-800 hover:text-[#F9A13D] mb-2 line-clamp-2">{{ $related->title }}
                                </h4>
    ...
    <div class="flex justify-between items-center border-t border-gray-400 shadow px-4 md:px-6 mt-3 pb-4 pt-5 bg-[#f0f0f0]">
        ...
        <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">
            Total reader comments: <span class="text-[#F9A13D] ml-1">{{ $article->comments_count }}</span>
        </span>
    </div>
