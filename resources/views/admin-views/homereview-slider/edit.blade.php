...
@section('title', 'Edit Home Review Slider')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ route('admin.homereview-slider.update', $slider->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="url" id="review_link" name="review_link"
                                                ...
                                                value="{{ old('review_link', $slider->review_link) }}" required>
                                            @error('review_link')
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            @if($slider->image)
                                                <div class="mt-2">
                                                    <p>Current Image:</p>
                                                    <img src="{{ asset('storage/' . $slider->image) }}" class="img-thumbnail"
                                                        width="200">
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-12 d-flex justify-content-end mt-3">
                                        <button type="submit" class="btn btn-primary me-2">
                                            <i class="bi bi-check-lg"></i> Update Slider
                                        </button>
