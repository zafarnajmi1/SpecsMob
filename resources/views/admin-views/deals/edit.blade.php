        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Deal</h3>
                    <p class="text-subtitle text-muted">Update deal or special offer information.</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">Created: {{ $deal->created_at->format('M d, Y \a\t H:i') }}</small>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    id="title" name="title" value="{{ old('title', $deal->title) }}"
                                ...
                                <select class="form-select @error('device_id') is-invalid @enderror" id="device_id"
                                    ...
                                    @foreach($devices as $device)
                                        <option value="{{ $device->id }}"
                                            {{ old('device_id', $deal->device_id) == $device->id ? 'selected' : '' }}>
                                            {{ $device->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('store_name') is-invalid @enderror"
                                    id="store_name" name="store_name" value="{{ old('store_name', $deal->store_name) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('region') is-invalid @enderror"
                                    id="region" name="region" value="{{ old('region', $deal->region) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" class="form-control @error('link') is-invalid @enderror"
                                    id="link" name="link" value="{{ old('link', $deal->link) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    name="price" value="{{ old('price', $deal->price) }}" placeholder="999.99">
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="memory" value="{{ old('memory', $deal->memory) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url"
                                    ...
                                    name="image_url" value="{{ old('image_url', $deal->image_url) }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                    ...
                                    placeholder="Add any additional details about this deal...">{{ old('description', $deal->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
