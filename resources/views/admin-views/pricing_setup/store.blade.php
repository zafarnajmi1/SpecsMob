                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="storeName" class="form-control" name="name"
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="storeLogo" class="form-control" name="logo"
                                            accept="image/*">
    ...
    <script>
        ...
        if (storeModal) {
            storeModal.addEventListener('show.bs.modal', function (event) {
                ...
                const removeLogoPreview = document.getElementById('removeLogoPreview');
        ...
        // Remove logo preview
        document.getElementById('removeLogoPreview')?.addEventListener('click', function (e) {
            e.preventDefault();
