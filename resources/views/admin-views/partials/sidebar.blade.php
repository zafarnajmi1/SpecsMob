...
<li class="sidebar-item has-sub {{ request()->routeIs('admin.articles.*', 'admin.tags.*') ? 'active' : '' }}">
...
<li class="sidebar-item has-sub {{ request()->routeIs('admin.countries.*','admin.currencies.*','admin.stores.*') ? 'active' : '' }}">
    <a href="#" class='sidebar-link'>
...
@canany(['review_manage', 'opinion_moderate', 'comment_moderate'])
    <li class="sidebar-item has-sub {{ request()->routeIs('admin.opinions.*', 'admin.comments.*', 'admin.article-comments.*') ? 'active' : '' }}">
        <a href="#" class='sidebar-link'>
...
{{-- Analytics & Reports --}}
@can('reports_view')
<li class="sidebar-item has-sub {{ request()->routeIs('admin.analytics.*', 'admin.reports.*') ? 'active' : '' }}">
    <a href="#" class='sidebar-link'>
